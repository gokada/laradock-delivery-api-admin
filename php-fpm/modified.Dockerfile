...
#! Modified
COPY ${CUSTOM_CONTEXT}./xdebug.ini /usr/local/etc/php/conf.d/xdebug.ini
...
#! Modified
COPY ${CUSTOM_CONTEXT}./opcache.ini /usr/local/etc/php/conf.d/opcache.ini
...
#! Modified
COPY ${CUSTOM_CONTEXT}./laravel.ini /usr/local/etc/php/conf.d
#! Modified
COPY ${CUSTOM_CONTEXT}./xlaravel.pool.conf /usr/local/etc/php-fpm.d/
