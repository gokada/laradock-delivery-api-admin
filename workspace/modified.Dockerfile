...
#! Modified
COPY ${CUSTOM_CONTEXT}./aliases.sh /root/aliases.sh
#! Modified
COPY ${CUSTOM_CONTEXT}./aliases.sh /home/laradock/aliases.sh
...
#! Modified
COPY ${CUSTOM_CONTEXT}./composer.json /home/laradock/.composer/composer.json

# Add the auth.json for magento 2 credentials
#! Modified
COPY ${CUSTOM_CONTEXT}./auth.json /home/laradock/.composer/auth.json
...
#! Modified
COPY ${CUSTOM_CONTEXT}./crontab /etc/cron.d
...
#! Modified
COPY ${CUSTOM_CONTEXT}./ca-certificates/* /usr/local/share/ca-certificates/
...
#! Modified
COPY ${CUSTOM_CONTEXT}./xdebug.ini /etc/php/${LARADOCK_PHP_VERSION}/cli/conf.d/xdebug.ini
...
#! Modified
COPY ${CUSTOM_CONTEXT}insecure_id_rsa /tmp/id_rsa
#! Modified
COPY ${CUSTOM_CONTEXT}insecure_id_rsa.pub /tmp/id_rsa.pub
...
#! Modified
COPY ${CUSTOM_CONTEXT}./.npmrc /root/.npmrc
#! Modified
COPY ${CUSTOM_CONTEXT}./.npmrc /home/laradock/.npmrc
...
#! Modified
COPY ${CUSTOM_CONTEXT}mc/config.json /root/.mc/config.json
...
#! Modified
COPY ${CUSTOM_CONTEXT}git-prompt.sh /tmp/git-prompt
